...
""".lstrip(
        ...
        expected_deposit = TxLedger(
            ...
            price_usd=Decimal("715.4103243232163000"),
            asset_price_id="bitcoin",
            isfee=0,
...
""".lstrip(
        ...
        expected_in = TxLedger(
            ...
            price_usd=Decimal("697.2773624560577000"),
            isfee=0,
        ...
        expected_out = TxLedger(
            ...
            to_address="Kraken:SomeKrakenAccountId",
            asset_tx_id="zec",
            asset_price_id="zcash",
            amount=Decimal("0.0036300000"),
            price_usd=Decimal("541.5290000000000000"),
            isfee=0,
            timestamp=int(arrow.get("2016-10-29 19:13:09").timestamp()),
            direction="OUT",
            tx_ledger_type="Kraken.trade",
...
""".lstrip(
        ...
        expected_deposit = TxLedger(
            ...
            price_usd=Decimal("127.0452580117980400"),
            isfee=0,
...
""".lstrip(
        ...
        expected_in = TxLedger(
            ...
            price_usd=Decimal("838.0499999999999992"),
            timestamp=int(arrow.get("2020-01-04T00:00:00Z").timestamp()),
            direction="IN",
            tx_ledger_type="Coinbase.Sell",
            isfee=0,
...
""".lstrip(
        ...
        expected_out = TxLedger(
            ...
            price_usd=Decimal("1031.7100000000000000"),
...
""".lstrip(
        ...
        expected_in = TxLedger(
            ...
            price_usd=Decimal("20452.3216432920000000"),
            timestamp=int(arrow.get("2021-12-06T06:22:49.825Z").timestamp()),
            direction="IN",
            tx_ledger_type="CoinbasePro.SELL",
            isfee=0,
        ...
        expected_fee = TxLedger(
            ...
            price_usd=Decimal("2.0454367080000000"),
            timestamp=int(arrow.get("2021-12-06T06:22:49.825Z").timestamp()),
            direction="OUT",
            tx_ledger_type="fee",
            isfee=1,
...
""".lstrip(
        ...
        expected_out = TxLedger(
            ...
            price_usd=Decimal("3610.3291923451183912"),
        ...
        expected_in = TxLedger(
            ...
            price_usd=Decimal("1.0029613747099249"),
            timestamp=int(arrow.get("2021-12-08 03:47:23.014").timestamp()),
            direction="IN",
            tx_ledger_type="Gemini.Buy",
            isfee=0,
        ...
        expected_fee = TxLedger(
            ...
            price_usd=Decimal("54.6075575737917613"),
            timestamp=int(arrow.get("2021-12-08 03:47:23.014").timestamp()),
            direction="OUT",
            tx_ledger_type="fee",
            isfee=1,
